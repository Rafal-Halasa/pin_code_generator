...
import com.simcodic.pincodegenerator.presentation.pins_list.PinsListViewModel
...
class MainActivity : ComponentActivity() {
    ...
    private val pinsListViewModel: PinsListViewModel by viewModels()
        ...
        setContent {
            PinCodeGeneratorTheme {
                Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
                    PinsListScreen(pinsListViewModel)
                }
            }
        }
    }
